...
enum ProjType{ProjSuface,ProjSharp,ProjCorner};
                        ...
                        ProjectionBase &PBasePoly)
{
    ...
    std::vector<size_t> cornersIdx;
    GetCorners(FeatureTris,FeatureTrisC,tri_mesh,poly_corner,poly_mesh,AvEdge,cornersIdx);
                          ...
                          size_t back_proj_steps)
{
    ...
    TriProjBase.VertProjType.resize(TriM.vert.size(),ProjSuface);
    PolyProjBase.VertProjType.resize(PolyM.vert.size(),ProjSuface);
...
//            PolyM.vert[i].SetS();
    ...
    for (size_t s=0;s<step_num;s++)
    {
        ...
        LaplacianEdgePos(PolyM,Damp,TargetPosSmooth);
                     ...
                     typename PolyMeshType::ScalarType AvEdge)
{
    ...
    MultiCostraintSmooth(poly_mesh,tri_mesh,trimesh_features,
                         ...
                         quad_corner,quad_face_partition,Damp,AvEdge,10,5);
